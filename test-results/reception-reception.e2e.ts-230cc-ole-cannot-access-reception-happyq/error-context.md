...
- Name: reception\reception.e2e.ts >> RBA — Reception denied for Accountant role >> RBA-REC-001: Billing role cannot access reception
- Location: projects\happyq\tests\reception\reception.e2e.ts:39:7
...
Locator: getByText(/not authorized|access denied|permission/i).first()
Expected: visible
Timeout: 8000ms
...
Call log:
  ...
  - waiting for getByText(/not authorized|access denied|permission/i).first()
