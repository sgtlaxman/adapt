...
- Name: patients\patients.e2e.ts >> Patients — Add Patient >> PAT-E2E-003: Add Patient dialog opens
- Location: projects\happyq\tests\patients\patients.e2e.ts:28:7
...
Expected: visible
Error: strict mode violation: getByRole('heading', { name: /patients/i }) resolved to 3 elements:
    ...
    3) <h3 class="text-lg font-semibold text-gray-900 mb-2">No patients found</h3> aka getByRole('heading', { name: 'No patients found' })
  ...
  - generic [ref=e19]:
    - generic [ref=e23]:
      ...
      - list [ref=e128]:
        - listitem [ref=e129]:
          - separator [ref=e130]
          - button "DP Dr. Pons User" [ref=e131] [cursor=pointer]:
            - generic [ref=e133]: DP
            - generic [ref=e134]:
      ...
      - generic [ref=e142]:
        - generic [ref=e143]:
          ...
          - generic [ref=e159]:
            ...
            - generic [ref=e167]:
              - button "All Locations" [ref=e168] [cursor=pointer]:
                - img
                - generic [ref=e169]: All Locations
              - generic [ref=e170]:
